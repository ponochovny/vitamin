<template>
    <div class="AddProduct">
        ...
        <h3>БЖУ <div></div></h3>
        <ul>
          <li v-for="(item, i) of productData.characteristics.foodEnergy" :key="item.title">
            <span>{{ item.title }}</span>
            <input type="text" v-model="productData.characteristics.foodEnergy[i].versions[0].value">
          </li>
        </ul>
